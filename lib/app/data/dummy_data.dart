...
final List<GridCategory> brandGridCategories = [
  GridCategory(
      ...
      title: 'Sofas',
      image:
          'https://ironstreets.com/wp-content/uploads/2026/01/Skyline-Lounge1.webp'),
  GridCategory(
      id: 142,
      title: 'Beds',
      image:
          'https://ironstreets.com/wp-content/uploads/2026/01/MetroGrid-Iron-Bed-Frame-Queen-Size1.webp'),
  GridCategory(
      id: 574,
      title: '6 Seater Dining',
      image:
          'https://ironstreets.com/wp-content/uploads/2026/04/Iron-Street-Product-Image-16.webp'),
  GridCategory(
    id: 145,
    title: 'Coffee Tables',
    image:
        'https://ironstreets.com/wp-content/uploads/2026/03/Sheesham-Wood-Coffee-Table-with-Metal-Legs1.webp',
  ),
  GridCategory(
      id: 203,
      title: 'Chairs',
      image:
          'https://ironstreets.com/wp-content/uploads/2026/03/Cozy-curve-lounger-chair-option-1.webp'),
  GridCategory(
      id: 290,
      title: 'Planters',
      image:
          'https://ironstreets.com/wp-content/uploads/2026/01/Botanic-Bridge-Pot-Stand-1.webp'),
];
...
final List<Product> discoverNewProducts = [
  Product(
    ...
    description:
        'Transform your living room into an elegant guest bedroom with the premium, strong, durable Ayaana Sheesham wood sofa cum bed. It features beautiful honey-finish cane weaving panels and thick high-resilience foam cushioning.',
    deliveryText: 'Ships in 2 Days',
    dimensions:
        'H 32 x W 76 x D 35 (Sofa mode), opens to 72 inches width Mattress',
  ...
  Product(
    ...
    description:
        'This ultra-luxurious, cozy Albus three-seater sofa boasts high-tensile strength support structures, modern velvet fabric padding in elegant ivory white, and deep soft seat cushions for your cozy evening conversations.',
  ...
  Product(
    ...
    description:
        'A beautiful compact media center with ample shelf space, wire cutouts, and charming sliding woven cane doors. Engineered with moisture-proof premium solid mango wood.',
  ...
  Product(
    ...
    description:
        'Experience effortless storage with our engineered pneumatic hydraulic system. Elegant tall teak headboard padded with ergonomic comfort fabric.',
...
final List<Product> topRatedProducts = [
  Product(
    ...
    description:
        'Add fluid elegance to your living room. The Osbert Curved Sofa features organic waves, tailored cotton fabric upholstery, and pocket-spring structure providing medium-firm plush comfort.',
    deliveryText: 'Ships in 4 Days',
    dimensions: 'H 31 x W 88 x D 38 Inches',
    material:
        'Premium Breathable Cotton Fabric, Strong ply & Solid pinewood core',
    category: 'Living',
  ),
  Product(
    id: 'p6',
    ...
    description:
        'Enjoy delicious family meals! Craftsmanship meets utility in this beautiful solid dining console complete with four premium tufted cushion seats.',
    deliveryText: 'Ships in 3 Days',
    dimensions:
        'Table: H 30 x W 48 x D 36 Inches, Chair: H 38 x W 18 x D 18 Inches',
  ...
  Product(
    ...
    description:
        'Boasting modular pull-out drawers, smart charging cable compartments, and sleek minimal wooden legs, Adrian desk keeps your productivity flawless.',
    deliveryText: 'Ships in 2 Days',
...
final List<FurnishingItem> homeFurnishingGrid = [
  FurnishingItem(
    ...
    priceText: 'From ₹749',
    image:
        'https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?w=300&auto=format&fit=crop&q=80',
  ),
  FurnishingItem(
    id: 'f2',
    title: 'Chair Covers',
    priceText: 'From ₹249',
    image:
        'https://images.unsplash.com/photo-1501876725168-00c445821c9e?w=300&auto=format&fit=crop&q=80',
  ),
  FurnishingItem(
    id: 'f3',
    title: 'Bed Sheets',
    priceText: 'From ₹999',
    image:
        'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?w=300&auto=format&fit=crop&q=80',
  ),
  FurnishingItem(
    id: 'f4',
    ...
    priceText: 'From ₹299',
    image:
        'https://images.unsplash.com/photo-1584100936595-c0654b55a2e2?w=300&auto=format&fit=crop&q=80',
  ),
  FurnishingItem(
    id: 'f5',
  ...
  FurnishingItem(
    ...
    priceText: 'From ₹749',
    image:
        'https://images.unsplash.com/photo-1600121848594-d8644e57abab?w=300&auto=format&fit=crop&q=80',
  ),
];
...
final List<DecorItem> homeDecorGrid = [
  ...
  DecorItem(
    ...
    priceText: 'From ₹605',
    image:
        'https://images.unsplash.com/photo-1531315630201-bb15abeb1653?w=300&auto=format&fit=crop&q=80',
  ),
  DecorItem(
    id: 'd3',
    title: 'Figurines',
    priceText: 'From ₹375',
    image:
        'https://images.unsplash.com/photo-1606744824163-985d376605aa?w=300&auto=format&fit=crop&q=80',
  ),
  DecorItem(
    id: 'd4',
    ...
    priceText: 'From ₹2799',
    image:
        'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=300&auto=format&fit=crop&q=80',
  ),
  DecorItem(
    id: 'd5',
    title: 'Vases',
    priceText: 'From ₹309',
    image:
        'https://images.unsplash.com/photo-1578500494198-246f612d3b3d?w=300&auto=format&fit=crop&q=80',
  ),
  DecorItem(
    id: 'd6',
    ...
    priceText: 'From ₹169',
    image:
        'https://images.unsplash.com/photo-1508781197106-d8c535dcf276?w=300&auto=format&fit=crop&q=80',
  ),
];
...
final List<Product> recentProducts = [
  Product(
    ...
    description:
        'Add a splash of organic symmetry and tribal artistry to your entrance, hallway, or dining space with our signature Bohemian Mirror set with durable Teak frames.',
    deliveryText: 'Ships in 2 Days',
